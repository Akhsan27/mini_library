        ...
        <div id="example">
            ...
            >
                <div className="header-content ">
                    ...
                    <nav>
                        <a href="#" className="px-3 py-2">Examples</a>
                        <a href="#" className="px-3 py-2">Blog</a>
                        <a href="#" className="bg-gray-300 px-3 py-2 rounded-2xl">Login</a>
                    </nav>
                </div>
            </motion.header>
            <StyleSheet />
